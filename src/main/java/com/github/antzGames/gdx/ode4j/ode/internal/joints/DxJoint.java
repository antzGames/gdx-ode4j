...
import com.github.antzGames.gdx.ode4j.ode.internal.DObject;
...
import static com.github.antzGames.gdx.ode4j.ode.internal.Common.dAtan2;
...
import static com.github.antzGames.gdx.ode4j.ode.internal.Rotation.dQMultiply1;
import static com.github.antzGames.gdx.ode4j.ode.internal.Rotation.dQMultiply2;
import static com.github.antzGames.gdx.ode4j.ode.internal.Rotation.dQMultiply3;
...
public abstract class DxJoint extends DObject implements DJoint {
	...
	public DJointFeedback feedback;   // optional feedback structure
...
//	dxBody dJointGetBody (dxJoint joint, int index)
	...
	public void dJointSetFeedback (DJointFeedback f)
	{
		//dAASSERT (joint);
		feedback = f;
	}
...
//	dJointFeedback dJointGetFeedback (dxJoint joint)
	DJointFeedback dJointGetFeedback ()
	{
		//dAASSERT (joint);
		return feedback;
	}
...
//	}
	...
	@Override
	public final void setFeedback(DJointFeedback fb)
	{ dJointSetFeedback(fb); }
	@Override
	public final DJointFeedback getFeedback()
