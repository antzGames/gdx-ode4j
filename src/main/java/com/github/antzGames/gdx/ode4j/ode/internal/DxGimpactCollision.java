...
import com.github.antzGames.gdx.ode4j.ode.internal.gimpact.GimTriCollision;
...
import com.github.antzGames.gdx.ode4j.ode.internal.gimpact.GimContact;
import com.github.antzGames.gdx.ode4j.ode.internal.gimpact.GimDynArray;
...
//					dVector3 dir, GREAL tmax, GIM_TRIANGLE_RAY_CONTACT_DATA *contact ) {
			static int gim_trimesh_ray_closest_collisionODE( GimTrimesh mesh, DVector3C origin, DVector3C dir, 
				...
				GimGeometry.vec3f dir_vec3f    = DVector3Tovec3f( dir );
				GimGeometry.vec3f origin_vec3f = DVector3Tovec3f( origin );
			...
			static void gim_trimesh_sphere_collisionODE( GimTrimesh mesh, DVector3C Position, 
				...
				GimGeometry.vec3f pos_vec3f = DVector3Tovec3f( Position );
			...
			static void gim_trimesh_plane_collisionODE( GimTrimesh mesh, DVector4 plane, 
					GimDynArray<GimGeometry.vec4f> contact ) {
				GimGeometry.vec4f plane_vec4f = DVector4Tovec4f( plane );
...
//				dst[ 5 ]= (src).maxZ;			
	...
	static void FetchTransformedTriangle(DxGimpact TriMesh, int Index, DVector3 Out[]){
		...
		GimGeometry.vec3f[] vOut = { new GimGeometry.vec3f(), new GimGeometry.vec3f(), new GimGeometry.vec3f() };
	...
	static void MakeMatrix(DVector3C Position, DMatrix3C Rotation, GimGeometry.mat4f m)
	{
