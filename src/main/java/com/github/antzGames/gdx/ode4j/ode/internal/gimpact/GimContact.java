...
import static com.github.antzGames.gdx.ode4j.ode.internal.gimpact.GimGeometry.VEC_COPY;
import static com.github.antzGames.gdx.ode4j.ode.internal.gimpact.GimGeometry.VEC_DOT;
import static com.github.antzGames.gdx.ode4j.ode.internal.gimpact.GimGeometry.VEC_NORMALIZE;
import static com.github.antzGames.gdx.ode4j.ode.internal.gimpact.GimGeometry.VEC_SCALE;
...
//		_hash += (*_uitmp)<<8;
	...
	static void GIM_PUSH_CONTACT(GimDynArray<GimContact> contact_array, GimGeometry.vec3f point,
                                 GimGeometry.vec3f normal, final float deep, GimTrimesh handle1, GimTrimesh handle2,
...
//	    GimContact _last = GIM_DYNARRAY_POINTER_LAST(GIM_CONTACT,contact_array);
	...
	static void GIM_PUSH_CONTACT(GimDynArray<GimContact> contact_array, GimGeometry.vec3f point,
                                 GimGeometry.vec4f normal, final float deep, GimTrimesh handle1, GimTrimesh handle2,
                                 final int feat1, final int feat2)
	{
//	    GIM_DYNARRAY_PUSH_EMPTY(GIM_CONTACT,contact_array);
//	    GimContact _last = GIM_DYNARRAY_POINTER_LAST(GIM_CONTACT,contact_array);
...
//						GDYNAMIC_ARRAY * dest_contacts)
			...
			final GimDynArray<GimContact> dest_contacts)
	{
		...
		for (int i = 0; i < source_count; i++) keycontacts[i] = new GimRadixSort.GIM_RSORT_TOKEN();
