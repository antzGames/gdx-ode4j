...
import static com.github.antzGames.gdx.ode4j.ode.internal.DxGimpactCollision.MakeMatrix;
...
//	}
	...
	void computeAABB()
	{
		...
		DxGimpactCollision.GIM_AABB_COPY( m_collision_trimesh.getAabbSet().getGlobalBound(), _aabb );
	}
	...
	void dGeomTriMeshGetPoint(int Index, double u, double v, DVector3 Out){
		GimGeometry.vec3f[] dv = { new GimGeometry.vec3f(), new GimGeometry.vec3f(), new GimGeometry.vec3f() };
