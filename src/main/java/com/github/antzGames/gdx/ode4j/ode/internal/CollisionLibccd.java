...
import com.github.antzGames.gdx.ode4j.ode.internal.libccd.CCD.ccd_center_fn;
import com.github.antzGames.gdx.ode4j.ode.internal.libccd.CCD.ccd_support_fn;
import com.github.antzGames.gdx.ode4j.ode.internal.libccd.CCDVec3.ccd_vec3_t;

import static com.github.antzGames.gdx.ode4j.ode.internal.DxCollisionUtil.dQuatTransform;
import static com.github.antzGames.gdx.ode4j.ode.internal.Rotation.dQFromAxisAndAngle;
import static com.github.antzGames.gdx.ode4j.ode.internal.Rotation.dQMultiply0;
import static com.github.antzGames.gdx.ode4j.ode.internal.libccd.CCD.*;
import static com.github.antzGames.gdx.ode4j.ode.internal.libccd.CCDMPR.*;
import static com.github.antzGames.gdx.ode4j.ode.internal.libccd.CCDVec3.*;
...
public class CollisionLibccd {
	...
	private static class ccd_obj_t {
		...
		final CCDQuat.ccd_quat_t rot = new CCDQuat.ccd_quat_t(), rot_inv = new CCDQuat.ccd_quat_t();
	};
	...
	static void ccdGeomToCap(final DxCapsule g, ccd_cap_t cap)
	{
		...
		CCDQuat.ccdQuatRotVec(cap.axis, cap.rot);
	...
	static void ccdGeomToCyl(final DxCylinder g, ccd_cyl_t cyl)
	{
		...
		CCDQuat.ccdQuatRotVec(cyl.axis, cyl.rot);
			...
			for (int i = 0; i < 3; i++) {
				...
				if (ccdVec3Dot(edgeNormal, v) < 0) {
					...
					if (ccdVec3Dot(edgeNormal, v) > 0) {
						...
						if (angle != 0.0) {
							CCDQuat.ccd_quat_t q = new CCDQuat.ccd_quat_t();
							CCDQuat.ccdQuatSetAngleAxis(q, angle, edgeAxis);
							CCDQuat.ccdQuatRotVec(contactNormal, q);
						}
						break;
					}
				}
