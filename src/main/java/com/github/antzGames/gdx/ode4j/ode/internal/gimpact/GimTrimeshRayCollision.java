...
//	#include "GIMPACT/gim_trimesh.h"
	...
	static int gim_trimesh_ray_collision(GimTrimesh trimesh, GimGeometry.vec3f origin, GimGeometry.vec3f dir,
                                         float tmax, GimTriCollision.GIM_TRIANGLE_RAY_CONTACT_DATA contact)
	{
	...
	//GREAL tmax, GIM_TRIANGLE_RAY_CONTACT_DATA * contact)
	static int gim_trimesh_ray_closest_collision(GimTrimesh trimesh, GimGeometry.vec3f origin, GimGeometry.vec3f dir,
                                                 float tmax, GimTriCollision.GIM_TRIANGLE_RAY_CONTACT_DATA contact)
	{
	    GimDynArrayInt collision_result = GimDynArrayInt.GIM_CREATE_BOXQUERY_LIST();
