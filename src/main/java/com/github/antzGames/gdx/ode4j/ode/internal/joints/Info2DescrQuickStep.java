...
public class Info2DescrQuickStep implements Info2Descr {
	...
	public void setJ1aCrossMatrix(int row, DVector3C a, double sign) {
		setJ1(row, JointEnums.GI2_JAY, -sign * a.get2());
		setJ1(row, JointEnums.GI2_JAZ, sign * a.get1());
		setJ1(row + 1, JointEnums.GI2_JAX, sign * a.get2());
		setJ1(row + 1, JointEnums.GI2_JAZ, -sign * a.get0());
		setJ1(row + 2, JointEnums.GI2_JAX, -sign * a.get1());
		setJ1(row + 2, JointEnums.GI2_JAY, sign * a.get0());
	}

	@Override
	public void setJ2aCrossMatrix(int row, DVector3C a, double sign) {
		setJ2(row, JointEnums.GI2_JAY, -sign * a.get2());
		setJ2(row, JointEnums.GI2_JAZ, sign * a.get1());
		setJ2(row + 1, JointEnums.GI2_JAX, sign * a.get2());
		setJ2(row + 1, JointEnums.GI2_JAZ, -sign * a.get0());
		setJ2(row + 2, JointEnums.GI2_JAX, -sign * a.get1());
		setJ2(row + 2, JointEnums.GI2_JAY, sign * a.get0());
	}

	@Override
	public void setJ1l(int row, double x, double y, double z) {
		setJ1(row, JointEnums.GI2_JLX, x);
		setJ1(row, JointEnums.GI2_JLY, y);
		setJ1(row, JointEnums.GI2_JLZ, z);
	}

	@Override
	public void setJ1a(int row, double x, double y, double z) {
		setJ1(row, JointEnums.GI2_JAX, x);
		setJ1(row, JointEnums.GI2_JAY, y);
		setJ1(row, JointEnums.GI2_JAZ, z);
	}

	@Override
	public void setJ2l(int row, double x, double y, double z) {
		setJ2(row, JointEnums.GI2_JLX, x);
		setJ2(row, JointEnums.GI2_JLY, y);
		setJ2(row, JointEnums.GI2_JLZ, z);
	}

	@Override
	public void setJ2a(int row, double x, double y, double z) {
		setJ2(row, JointEnums.GI2_JAX, x);
		setJ2(row, JointEnums.GI2_JAY, y);
		setJ2(row, JointEnums.GI2_JAZ, z);
	}

	@Override
	public void setJ1l(int row, int i, double d) {
		setJ1(row, i + JointEnums.GI2_JLX, d);
	}

	@Override
	public void setJ2l(int row, int i, double d) {
		setJ2(row, i + JointEnums.GI2_JLX, d);
	}

	@Override
	public void setJ1a(int row, int i, double d) {
		setJ1(row, i + JointEnums.GI2_JAX, d);
	}

	@Override
	public void setJ2a(int row, int i, double d) {
		setJ2(row, i + JointEnums.GI2_JAX, d);
	}
