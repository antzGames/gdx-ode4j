...
//From config-defaults.h
	...
	public static final void dIASSERT(boolean b) {
		if (!b) {
			ErrorHandler.dDebug(d_ERR_IASSERT, "assertion failed ");
	...
	public static void dUASSERT(DxBody  a, String msg) {
		if (a == null) {
			ErrorHandler.dDebug (d_ERR_UASSERT, msg);
		}
	}
...
//		new RuntimeException(msg).printStackTrace(new PrintWriter(sw));
		...
		ErrorHandler.dMessage (d_ERR_UASSERT, msg2);
	...
	public static void dAASSERT(DGeom.DNearCallback a) {
		if (a == null) {
			dUASSERT(0, "Bad argument(s)");
		}
	}
...
//	#  endif
	public static void dICHECK(boolean a) {
		if (!a) {
			ErrorHandler.dDebug(d_ERR_IASSERT, "", (Object[])null);
		}
	}
