...
import com.github.antzGames.gdx.ode4j.ode.DDoubleHingeJoint;
...
//    virtual size_t size() const;
    ...
    getInfo2( double worldFPS, double worldERP, Info2Descr info )
    {
        ...
        OdeMath.dPlaneSpace(globalAxis1, p, q);
        info.setJ1a(1, p);
        info.setJ1a(2, q);
        ...
        OdeMath.dCalcVectorCross3(u, globalAxis1, globalAxis2);
        ...
        if ( node[1].body != null ) {
            ...
            OdeMath.dCalcVectorCross3(omega, h, globalAxis1);
...
//            joint->axis2[2] = z;
    ...
    void dJointSetDHingeParam( PARAM parameter, double value )
    {
        dJointSetDBallParam(parameter, value);
    }


    double dJointGetDHingeParam( PARAM parameter )
    {
