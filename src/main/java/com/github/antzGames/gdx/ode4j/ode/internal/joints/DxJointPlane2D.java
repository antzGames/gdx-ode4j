...
import com.github.antzGames.gdx.ode4j.ode.DPlane2DJoint;
...
//	}
	...
	public void dJointSetPlane2DXParam(
            DJoint.PARAM_N parameter, double value )
	{
	...
	public double getXParamFMax() {
		return motor_x.get( DJoint.PARAM.dParamFMax );
	}

	@Override
	public double getYParamFMax() {
		return motor_y.get( DJoint.PARAM.dParamFMax );
	}
	...
	public double getXParamVel() {
		return motor_x.get( DJoint.PARAM.dParamVel );
	}

	@Override
	public double getYParamVel() {
		return motor_y.get( DJoint.PARAM.dParamVel );
	}
