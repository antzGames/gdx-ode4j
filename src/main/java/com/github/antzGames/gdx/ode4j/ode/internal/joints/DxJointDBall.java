...
import com.github.antzGames.gdx.ode4j.ode.DDoubleBallJoint;
...
public class DxJointDBall extends DxJoint implements DDoubleBallJoint {
	...
	void dJointSetDBallParam(PARAM parameter, double value )
	{
		switch ( parameter ) {
		case dParamCFM:
			cfm = value;
	...
	double dJointGetDBallParam(PARAM parameter )
	{
		switch ( parameter ) {
		case dParamCFM:
			return cfm;
