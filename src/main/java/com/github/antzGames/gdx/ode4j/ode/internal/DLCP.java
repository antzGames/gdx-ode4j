...
import com.github.antzGames.gdx.ode4j.ode.OdeConfig;
import com.github.antzGames.gdx.ode4j.ode.internal.processmem.DxWorldProcessMemArena;
import com.github.antzGames.gdx.ode4j.math.DMatrixN;
import com.github.antzGames.gdx.ode4j.ode.DStopwatch;
import com.github.antzGames.gdx.ode4j.ode.internal.processmem.DxUtil.BlockPointer;

import text.formic.Stringf;

import static com.github.antzGames.gdx.ode4j.ode.OdeConstants.dInfinity;
...
import static com.github.antzGames.gdx.ode4j.ode.internal.Common.dNODEBUG;
import static com.github.antzGames.gdx.ode4j.ode.internal.Common.dPAD;
import static com.github.antzGames.gdx.ode4j.ode.internal.Common.dRecip;
import static com.github.antzGames.gdx.ode4j.ode.internal.Common.d_ERR_LCP;
import static com.github.antzGames.gdx.ode4j.ode.internal.ErrorHandler.dDebug;
import static com.github.antzGames.gdx.ode4j.ode.internal.ErrorHandler.dMessage;
import static com.github.antzGames.gdx.ode4j.ode.internal.FastDot.dDot;
import static com.github.antzGames.gdx.ode4j.ode.internal.Matrix.dFactorLDLT;
import static com.github.antzGames.gdx.ode4j.ode.internal.Matrix.dSetZero;
import static com.github.antzGames.gdx.ode4j.ode.internal.Matrix.dSolveLDLT;
import static com.github.antzGames.gdx.ode4j.ode.internal.Misc.dClearUpperTriangle;
import static com.github.antzGames.gdx.ode4j.ode.internal.Misc.dMakeRandomMatrix;
import static com.github.antzGames.gdx.ode4j.ode.internal.Misc.dMaxDifference;
import static com.github.antzGames.gdx.ode4j.ode.internal.Misc.dRandReal;
import static com.github.antzGames.gdx.ode4j.ode.internal.cpp4j.java.Cstring.memcpy;
import static com.github.antzGames.gdx.ode4j.ode.internal.cpp4j.java.Cstring.memmove;
...
//#ifdef dLCP_FAST
	...
	private double AiC_times_qC (int i, double[] q) { return dDot(m_A, AROWp(i),q,0,m_nC); }
	private double AiN_times_qN (int i, double[] q) { return dDot(m_A, AROWp(i)+m_nC,q,m_nC,m_nN); }
...
//	{ for (int i=0; i<nN; i++) p[i+nC] += s*q[i+nC]; }
                           ...
                           double[] outer_w, int nub, double[] lo, double[] hi, int []findex)
	{
		...
		if (nub >= n) {
		    ...
		    int nskip = dPAD(n);
			dFactorLDLT(A,d,n,nskip);		// use w for d
...
//    }
            ...
            // pacifier
            System.out.println(Stringf.format("passed: NL=%3d NH=%3d C=%3d   ", n1, n2, n3));
            System.out.println(Stringf.format("time=%10.3f ms  avg=%10.4f\n",time * 1000.0,average));
            }
