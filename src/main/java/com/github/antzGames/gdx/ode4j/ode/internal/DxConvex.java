...
import com.github.antzGames.gdx.ode4j.ode.DConvex;
...
import static com.github.antzGames.gdx.ode4j.ode.OdeConstants.CONTACTS_UNIMPORTANT;
...
import static com.github.antzGames.gdx.ode4j.ode.internal.cpp4j.java.Cmath.fabs;
	...
	DxConvex (DxSpace space,
		...
		if (!dNODEBUG) {//#ifndef dNODEBUG
			...
			for(int i=0;i<planecount;++i)
			{
				...
				{
                    System.out.println(Stringf.format("WARNING: Polygon %d is not defined counterclockwise\n",i));
				}
				...
				if(planesD[i]<0) System.out.println(Stringf.format("WARNING: Plane %d does not contain the origin\n",i));
			}
		} //#endif dNODEBUG
