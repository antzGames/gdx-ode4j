...
import com.github.antzGames.gdx.ode4j.ode.DHashSpace;
import com.github.antzGames.gdx.ode4j.ode.internal.cpp4j.java.Cmath;
...
public class DxHashSpace extends DxSpace implements DHashSpace {
	...
	private static int findLevel (DAABB boundsV) //[6])
	{
		...
		Cmath.frexp (q,level);	// q = (0.5 .. 1.0) * 2^level (definition of frexp)
		return level.i;
	}
