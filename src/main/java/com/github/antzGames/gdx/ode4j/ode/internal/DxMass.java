...
import com.github.antzGames.gdx.ode4j.ode.internal.cpp4j.java.FormattedStringBuilder;
...
import static com.github.antzGames.gdx.ode4j.ode.OdeMath.dSetCrossMatrixPlus;
...
import static com.github.antzGames.gdx.ode4j.ode.internal.Matrix.dIsPositiveDefinite;
...
//	private int _I(int i, int j) {return i * 4 + j;}
	...
	public boolean dMassCheck ()
	{
		...
		if (!Matrix.dIsPositiveDefinite (_I)) {
